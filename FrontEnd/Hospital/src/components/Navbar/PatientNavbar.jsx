...
const navLinks = [
  ...
  { name: "My Tokens", href: "/patient/tokens", icon: Ticket },
  { name: "Visit History", href: "/patient/history", icon: History },
];
        ...
        <div className="h-16 flex items-center justify-between">
          ...
          >
            <motion.div 
              ...
              className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-500/10 to-emerald-500/10 border border-cyan-500/20"
            >
              ...
              <button className="flex items-center gap-3 group">
                ...
                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-cyan-400 to-blue-500 p-[2px]">
                   <div className="w-full h-full rounded-full bg-white dark:bg-gray-950 overflow-hidden">
                    <img
                        src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${user?.name || "Patient"}`}
                        alt="Profile"
        ...
        {mobileOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-1">
              ...
              <motion.button
                variants={mobileItemVariants}
                onClick={() => { navigate("/patient/profile"); setMobileOpen(false); }}
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-900"
              >
