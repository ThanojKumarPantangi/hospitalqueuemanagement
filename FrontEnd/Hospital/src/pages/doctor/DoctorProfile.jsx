...
const DoctorProfile = () => {
  ...
  const hasChanges = (() => {
    ...
    return current !== originalDataRef.current;
  })();
              ...
              <motion.div variants={itemVars} className="lg:col-span-8 space-y-8">
                  ...
                  <div className="p-8 border-b border-gray-50 dark:border-gray-800 flex justify-between items-center bg-gray-50/30 dark:bg-gray-800/20">
                      ...
                      <motion.button 
                        ...
                        className={`relative overflow-hidden group px-8 py-3 rounded-2xl font-bold text-sm transition-all
                          ${hasChanges 
                            ? "bg-gradient-to-r from-violet-500 to-purple-600 text-white shadow-lg shadow-violet-500/30 hover:shadow-xl hover:shadow-violet-500/40" 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                          ...
                          <div className="relative">
                            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-violet-500 dark:text-violet-400">
                            ...
                            <input
                              ...
                              className="
                                ...
                                shadow-inner shadow-gray-200/40 dark:shadow-black/20
                                cursor-not-allowed
                                opacity-90
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="relative">
                            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-500 dark:text-indigo-400 pointer-events-none">
                              <Clock size={18} />
                            </div>
